...
directory_path = "C:/Users/chira/Desktop/bmsit/voice"
...
for wave_file in glob.glob(f"{directory_path}/*.wav"):  # Assuming the audio files are in WAV format
...
df.to_csv("processed_results1.csv", index=False)
df
